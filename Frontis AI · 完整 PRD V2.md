...
6. 用户工作台和企业管理后台服务于企业内部使用；运营管理平台服务于平台级治理。
...
2. 员工在 AI专家广场中浏览当前租户可用的 AI 专家，包括企业自研专家与 FrontisAI发布的专家。
3. 员工可将当前有权限使用的 AI 专家直接添加到工作台。
4. 如果员工在左侧专家列表中选择其它 AI 专家，则进入该专家的一对一独立使用模式，不再由 `MetaAegnt` 代为调度。
5. 员工在开发与进化中创建和编辑自己的 AI 专家。
6. 员工发布 AI 专家为 `个人 / 团队共享 / 企业公开`。
...
| AI专家广场 | 专家详情 | 个人专家进入开发 | 对“自己开发且当前处于个人范围”的 AI 专家，不应鼓励再次添加，而应提供 `进入开发` 入口。该入口用于引导开发者继续迭代自己的专家能力，而不是把自己私有专家当成重复消费对象。 | P1 |
...
| 开发与进化 | 发布管理 | 团队共享 | 发布为团队共享后，开发者可选择共享给指定部门或成员，被共享对象可在 AI专家广场中看到并直接添加到工作台使用。该能力用于企业内部小范围协作场景。 | P0 |
| 开发与进化 | 发布管理 | 企业公开发布 | 发布为企业公开后，该 AI 专家仅在当前租户内对所有成员可见可用，不代表自动进入平台 AI 专家广场。企业公开用于企业内部全员共享场景，需要在产品语义上与团队共享、个人发布和平台上架明确区分。 | P0 |
| 开发与进化 | 发布管理 | 发布范围选择 | 每次发布都必须明确设置发布范围，系统需要保证 `个人 / 团队共享 / 企业公开` 三种范围语义清晰、互斥且可解释。发布范围是决定 AI 专家在当前租户内谁能看到、谁能使用、是否允许进一步申请上架的前置条件。 | P0 |
...
1. 员工开发完成 AI 专家后，可直接发布到 AI专家广场。
2. 发布只解决当前租户内的使用范围，不经过运营审批。
3. 只有自己开发的 AI 专家才允许发起上架申请。
4. 只有当前租户开通了 AI 专家开发服务，才允许发起上架申请。
5. 上架申请提交后，进入运营平台的 `AI 专家上架审批`。
6. 审批通过后，AI 专家进入平台 AI 专家广场管理，由运营决定是否投放以及投放给哪些租户。
...
2. 管理员查看企业内全部 AI 专家，包括企业自研专家和已接入到本企业的平台专家。
...
| 功能模块 | 一级功能 | 二级功能 | 功能描述 | 优先级 |
|---|---|---|---|---|
| AI 专家管理 | 资产总览 | AI 专家列表 | `AI 专家管理` 是企业后台的一级核心功能，列表页需要统一展示企业内全部 AI 专家资产，包括企业自研专家和已接入到本企业的平台专家。列表的目标不是展示交易状态，而是帮助管理员从企业治理视角看清“当前企业里到底有哪些专家正在存在和被管理”。 | P0 |
| AI 专家管理 | 资产识别 | 开发者与来源识别 | 在 AI 专家列表中，每个专家都必须明确展示开发者、当前来源说明和基础状态，帮助管理员判断这个专家是谁创建的、是企业自研产出的还是平台接入能力、当前应该由谁负责。该功能用于解决企业内 AI 资产归属不清的问题。 | P0 |
| AI 专家管理 | 资产识别 | 企业内发布范围查看 | 对企业自研专家，管理员需要直接看到其企业内发布范围是 `企业公开 / 团队共享 / 个人`；对平台接入专家，则需要看到其来源和当前企业启用状态。该字段用于帮助管理员理解该专家在本企业中的覆盖面和治理方式。 | P0 |
...
1. 企业管理后台看到的是企业内全部 AI 专家资产，包括企业自研资产和平台接入资产。
...
3. `个人` AI 专家只由开发者本人可见。
4. 平台接入专家是否对本企业成员可见，取决于平台投放结果与企业内启用配置。
5. 企业管理员可以看到全部 AI 专家，但“看得到”不等于“所有人都能用”。
...
| 来源 | 含义 |
|---|---|
| 企业自研 | 本企业员工开发并在企业内发布的 AI 专家 |
| 平台接入 | 平台 AI 专家广场投放到本企业后被接入使用的 AI 专家 |
