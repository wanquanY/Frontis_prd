...
- 平台侧：默认注册版本、注册赠送积分、积分包设置、商品中心、AI专家广场投放、AI专家广场分类管理、客服配置、资源计量、运营账号与角色管理、全平台预设角色管理
...
4. 用户侧 AI 专家广场分类、投放范围、上架状态和排序规则。
5. 默认客服二维码、商品专属客服二维码和咨询备注模板。
6. 团队版套餐、单席位价格、订单与资源池作为底层能力保留。
7. 运营账号、运营角色和租户侧平台预设角色的统一治理。
...
| AI专家广场治理 | 分类管理 | 广场分类维护 | 维护用户侧 AI 专家广场分类名称、排序、启用状态和分类下专家归属，用于承接 FrontisAI 发布与团队分享专家的浏览结构。 | P0 |
