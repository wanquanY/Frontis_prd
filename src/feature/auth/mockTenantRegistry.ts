...
const PRESET_TENANT_SNAPSHOTS: MockTenantManagementSnapshot[] = [
  {
    ...
    includedSeats: 20,
    extraSeatCount: 4,
    teamPlanPackageId: "team-yearly-seat-package",
    ...
    agentUsageRecords: [
      ...
      buildAgentUsageRecordItem({
        id: "tenant-enterprise-demo-agent-usage-01-02",
        actorName: "王晨",
        agentName: "序列总览专家",
        departmentName: "销售一部",
        inputTokens: 156000,
      ...
      buildAgentUsageRecordItem({
        id: "tenant-enterprise-demo-agent-usage-01-03",
        actorName: "林若岚",
        agentName: "序列总览专家",
        departmentName: "客户成功",
        inputTokens: 132000,
        ...
        callCount: 16,
        costAmount: 202,
        humanCostAmount: 2400,
        industryBenchmarkCostAmount: 1600,
        occurredAt: "昨天 17:45",
      }),
      buildAgentUsageRecordItem({
        id: "tenant-enterprise-demo-agent-usage-01-04",
        actorName: "赵明",
        agentName: "序列总览专家",
        departmentName: "商品运营",
        inputTokens: 98000,
        ...
        callCount: 12,
        costAmount: 154,
        humanCostAmount: 1900,
        industryBenchmarkCostAmount: 1200,
        occurredAt: "2026-04-22 16:10",
      }),
      buildAgentUsageRecordItem({
      ...
      buildAgentUsageRecordItem({
        id: "tenant-enterprise-demo-agent-usage-02-02",
        actorName: "陈可心",
        agentName: "需求拆解专家",
        departmentName: "市场运营",
        inputTokens: 126000,
        ...
        callCount: 15,
        costAmount: 196,
        humanCostAmount: 2100,
        industryBenchmarkCostAmount: 1400,
        occurredAt: "昨天 10:30",
      }),
      buildAgentUsageRecordItem({
        id: "tenant-enterprise-demo-agent-usage-02-03",
        actorName: "林若岚",
        agentName: "需求拆解专家",
        departmentName: "客户成功",
        inputTokens: 88000,
        ...
        callCount: 11,
        costAmount: 136,
        humanCostAmount: 1600,
        industryBenchmarkCostAmount: 980,
        occurredAt: "2026-04-22 09:35",
      }),
      buildAgentUsageRecordItem({
    ...
    subscriptionOrders: [
      buildSubscriptionOrderItem({
        ...
        planKey: "team-yearly-seat-package",
        planTitle: "年席位包",
        amount: 47976,
        seatCount: 24,
        billingCycleLabel: "1 年",
        status: "paid",
  ...
  },
  {
    ...
    pointsOrders: [
      buildPointsOrderItem({
        id: "tenant-enterprise-hq-points-order-00",
        orderNo: "PT-20260424-001",
        packageId: "standard",
        packageTitle: "标准积分包",
        packagePoints: 10000,
        giftPoints: 100,
  ...
  },
  {
    ...
    subscriptionOrders: [
      buildSubscriptionOrderItem({
        ...
        planKey: "team-monthly-seat-package",
        planTitle: "月席位包",
        amount: 995,
        seatCount: 5,
