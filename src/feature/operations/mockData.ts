...
export const OPERATIONS_INITIAL_METERING_PROVIDERS: OperationsMeteringProvider[] = [
  ...
  {
    id: "ops-metering-provider-anthropic",
    name: "Anthropic Claude",
    providerKind: "largeModel",
    baseUrl: "https://api.anthropic.com",
    billingCurrency: "CNY",
    credentialStatusLabel: "sk-ant-****",
    status: "active",
    updatedAt: "2026-04-23 11:25",
  },
  {
...
export const OPERATIONS_INITIAL_MODEL_SERVICES: OperationsModelService[] = [
  {
    ...
    protocolConfigs: [
      {
        protocol: "openai",
        inputCostPerMillion: 14.4,
        cachedInputCostPerMillion: 3.6,
        outputCostPerMillion: 57.6,
        inputSalePricePerMillion: 20.16,
        cachedInputSalePricePerMillion: 5.04,
        outputSalePricePerMillion: 80.64,
      },
      {
        protocol: "claude",
        inputCostPerMillion: 14.4,
        cacheCreationCostPerMillion: 18,
        cacheReadCostPerMillion: 1.44,
        outputCostPerMillion: 57.6,
        inputSalePricePerMillion: 20.16,
        cacheCreationSalePricePerMillion: 25.2,
        cacheReadSalePricePerMillion: 2.016,
        outputSalePricePerMillion: 80.64,
      },
    ],
    pricingMode: "markup",
  ...
  {
    id: "ops-model-service-claude-3-7-sonnet",
    providerId: "ops-metering-provider-anthropic",
    modelCode: "claude-3-7-sonnet-20250219",
    modelName: "Claude 3.7 Sonnet",
    protocolConfigs: [
      {
        protocol: "openai",
        inputCostPerMillion: 21.6,
        cachedInputCostPerMillion: 2.16,
        outputCostPerMillion: 108,
        inputSalePricePerMillion: 29.16,
        cachedInputSalePricePerMillion: 2.916,
        outputSalePricePerMillion: 145.8,
      },
      {
        protocol: "claude",
        inputCostPerMillion: 21.6,
        cacheCreationCostPerMillion: 27,
        cacheReadCostPerMillion: 2.16,
        outputCostPerMillion: 108,
        inputSalePricePerMillion: 29.16,
        cacheCreationSalePricePerMillion: 36.45,
        cacheReadSalePricePerMillion: 2.916,
        outputSalePricePerMillion: 145.8,
      },
    ],
    pricingMode: "markup",
    ...
    protocolConfigs: [
      {
        ...
        cachedInputSalePricePerMillion: 1.35,
      ...
      },
      {
        ...
        outputCostPerMillion: 12,
        inputSalePricePerMillion: 5.4,
        cacheCreationSalePricePerMillion: 6.75,
        cacheReadSalePricePerMillion: 0.54,
        outputSalePricePerMillion: 16.2,
      },
    ],
    pricingMode: "markup",
    ...
    protocolConfigs: [
      {
        ...
        cachedInputCostPerMillion: 0.9,
        outputCostPerMillion: 0,
        inputSalePricePerMillion: 1.44,
        cachedInputSalePricePerMillion: 1.44,
        outputSalePricePerMillion: 0,
      },
      {
        protocol: "claude",
        inputCostPerMillion: 0.9,
        cacheCreationCostPerMillion: 1.125,
        cacheReadCostPerMillion: 0.09,
        outputCostPerMillion: 0,
        inputSalePricePerMillion: 1.44,
        cacheCreationSalePricePerMillion: 1.8,
        cacheReadSalePricePerMillion: 0.144,
        outputSalePricePerMillion: 0,
      },
    ],
    pricingMode: "markup",
