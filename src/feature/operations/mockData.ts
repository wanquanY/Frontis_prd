...
export const OPERATIONS_INITIAL_MODEL_SERVICES: OperationsModelService[] = [
  {
    ...
    modelCode: "gpt-4.1",
    modelName: "GPT-4.1",
    modelRegion: "overseas",
    modelValue: "gpt-4.1,gpt-4.1-2025-04-14",
    interfaceFormat: "openai",
    inputCostPerMillion: 14.4,
    cacheCostPerMillion: 3.6,
    outputCostPerMillion: 57.6,
    pricingMode: "markup",
    markupRate: 1.4,
    grossMarginRate: 30,
    inputSalePricePerMillion: 20.16,
    cacheSalePricePerMillion: 5.04,
  ...
  },
  {
    ...
    modelName: "Claude 3.7 Sonnet",
    modelRegion: "overseas",
    modelValue: "claude-3-7-sonnet-20250219",
    interfaceFormat: "claude",
    inputCostPerMillion: 21.6,
    cacheCostPerMillion: 2.16,
    outputCostPerMillion: 108,
    pricingMode: "markup",
    markupRate: 1.35,
    grossMarginRate: 30,
    inputSalePricePerMillion: 29.16,
    cacheSalePricePerMillion: 2.916,
  ...
  },
  {
    ...
    modelRegion: "overseas",
    modelValue: "text-embedding-3-large",
    interfaceFormat: "openai",
    inputCostPerMillion: 0.9,
    cacheCostPerMillion: 0.9,
    outputCostPerMillion: 0,
    pricingMode: "markup",
    markupRate: 1.6,
    grossMarginRate: 30,
    inputSalePricePerMillion: 1.44,
    cacheSalePricePerMillion: 1.44,
