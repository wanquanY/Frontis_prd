...
export const INITIAL_EMPLOYEES: EmployeeItem[] = [
  ...
  },
  {
    ...
    role: "排期跟进、提测检查、发布协调",
    status: "paused",
    workspaceId: "workspace-local-bj",
    connectionMode: "cloud",
    model: "gpt-4o",
  ...
  },
  {
    ...
    connectionMode: "cloud",
    model: "gpt-4-turbo",
    summary: "汇总销售线索、生成战报，跟进重点客户动态。",
    lastAction: "已完成今日销售战报汇总",
    source: "openclaw",
    visibility: "bound",
    subAgentModel: "gpt-3.5-turbo",
    ...
    skills: ["线索跟进", "战报生成", "客户分析"],
  },
  {
    id: "employee-store-ops",
    name: "门店运营助手",
    avatarUrl: getAvatarUrl("employee-store-ops"),
    role: "门店运营数据跟踪与客流分析",
    status: "online",
    workspaceId: "workspace-local-sh",
    connectionMode: "local",
    model: "gpt-4-turbo",
    summary: "部署在门店本地盒子上，实时跟踪门店运营数据。",
    lastAction: "已完成今日客流数据分析报告",
    source: "coworker",
    visibility: "all",
    subAgentModel: "gpt-3.5-turbo",
    agentId: "cw-agent-store-ops-01",
    runtimeAgentId: "rt-agent-store-ops-01",
    boundMembers: ["杨万泉", "运营组"],
    welcomeMessage: "我会跟踪门店运营数据、分析客流趋势，输出每日运营报告。",
    systemPrompt: "你是一名门店运营助手，负责门店运营数据跟踪、客流分析、库存预警和运营报表生成。",
    skills: ["客流分析", "运营报表", "库存预警"],
  },
];
