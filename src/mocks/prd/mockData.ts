...
import type {
  ...
  SkillItem,
  WorkspaceItem,
} from "@/pages/prd/types";
import { createPrdWorkspaceActivationInfo, getPrdAvatarUrl } from "@/pages/prd/utils";
...
const createPrdDataUrl = (mimeType: string, content: string): string =>
  `data:${mimeType};charset=utf-8,${encodeURIComponent(content)}`;

const createPrdSvgDataUrl = (content: string): string =>
...
export const INITIAL_EMPLOYEES: EmployeeItem[] = [
  {
    id: "employee-pm",
    name: "产品策略官",
    avatarUrl: getPrdAvatarUrl("employee-pm"),
    role: "拆需求、出方案、推进落地",
    status: "busy",
  ...
  },
  {
    ...
    name: "交互设计师",
    avatarUrl: getPrdAvatarUrl("employee-designer"),
    role: "页面布局、视觉和动线调整",
    status: "idle",
    workspaceId: "workspace-cloud",
    connectionMode: "cloud",
  ...
  },
  {
    ...
    name: "资料研究员",
    avatarUrl: getPrdAvatarUrl("employee-research"),
  ...
  },
  {
    id: "employee-ops",
    name: "上线协调员",
    avatarUrl: getPrdAvatarUrl("employee-ops"),
    role: "排期跟进、提测检查、发布协调",
    status: "paused",
    workspaceId: "workspace-cloud",
    connectionMode: "cloud",
  ...
  },
  {
    id: "employee-writer",
    name: "本地内容助理",
    avatarUrl: getPrdAvatarUrl("employee-writer"),
    role: "会议纪要、文档整理、附件归档",
    status: "idle",
  ...
  },
  {
    id: "employee-sales",
    name: "销售战报助手",
    avatarUrl: getPrdAvatarUrl("employee-sales"),
    role: "企业线索跟进和日报生成",
    status: "paused",
  ...
  "dialogue-session-pm-1": [
    {
      ...
      fileSize: "2 KB",
      taskName: "对话功能拆解",
      canonicalPath: createPrdDataUrl(
        "text/markdown",
        "# 独立窗口功能拆解\n\n- 对话页保留 AI 切换与最近会话\n- 群聊页补齐成果面板\n- 云端模式支持桌面小窗与分屏\n",
      ),
  ...
  "dialogue-session-designer-1": [
    {
      ...
      fileSize: "5 KB",
      taskName: "输入区对齐",
      canonicalPath: createPrdSvgDataUrl(
  ...
  "channel-prd": [
    {
      ...
      fileSize: "2 KB",
      taskName: "独立窗口方案收口",
      canonicalPath: createPrdDataUrl("text/markdown", PRD_ACCEPTANCE_MARKDOWN),
      mimeType: "text/markdown",
    },
    {
      ...
      fileSize: "4 KB",
      taskName: "频道成果页复用",
      canonicalPath: createPrdDataUrl("text/html", PRD_REVIEW_HTML),
      mimeType: "text/html",
    },
    {
      ...
      fileSize: "1 KB",
      taskName: "组件复用梳理",
      canonicalPath: createPrdDataUrl("application/json", PRD_LAYOUT_DIFF_JSON),
      mimeType: "application/json",
    },
    {
      ...
      fileSize: "6 KB",
      taskName: "成果流转图",
      canonicalPath: createPrdSvgDataUrl(PRD_FLOWCHART_SVG),
      mimeType: "image/svg+xml",
    },
  ],
  "channel-launch": [
